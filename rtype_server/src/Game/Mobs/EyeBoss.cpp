...
static void shortRangeBehavior(RealEngine::Registry& registry, RealEngine::Entity& entity,
    ...
    auto* targetPosition = registry.getComponent<RealEngine::Position>(target);
...
static void targetBossBehavior(RealEngine::Registry& registry, RealEngine::Entity entity,
    ...
    aimAtTarget(entity, registry.getComponent<RealEngine::Position>(*(target->target)), registry,
...
EyeBoss::EyeBoss(RealEngine::Registry& registry, sf::Vector2f position)
    ...
    registry.addComponents(_entity, RealEngine::Position{position.x, position.y});
    registry.addComponent(_entity, RealEngine::Velocity{0.0f, 0.0f, {300.0f, 300.0f}, 1.8f});
    registry.addComponent(_entity, RealEngine::Acceleration{2.0f, 2.0f, 2.0f});
    ...
    registry.addComponent(_entity,
                          RealEngine::Collision{{0.0f, 0.0f, 15.f * GAME_SCALE, 10.f * GAME_SCALE},
                                                ...
                                                takesDamage});
    registry.addComponent(_entity, RealEngine::Health{1000, 1000});
    registry.addComponent(_entity, RealEngine::Damage{20});
    registry.addComponent(_entity, RealEngine::Radius{800.0f, 200.0f, setBossStatusMid, doNothing,
                                                      setBossStatusShort});
    registry.addComponent(_entity, RealEngine::AI{targetBossBehavior, circularAttack, true});
    registry.addComponent(_entity, RealEngine::TargetRadius{500.0f, false});
