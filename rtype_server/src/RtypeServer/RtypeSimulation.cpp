...
//         player_uuid,
//         sf::IntRect(static_cast<int>(player_direction_x.x),
//         static_cast<int>(player_direction_x.y),
//                     static_cast<int>(player_direction_y.x),
//                     static_cast<int>(player_direction_y.y)),
