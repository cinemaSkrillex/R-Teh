...
EyeBoss::EyeBoss(RealEngine::Registry& registry)
    : _state(EyeBossState::SHORT_RANGE),
      ...
      _shortSprite(std::string(ASSETS_PATH) + "/sprites/the_eye/boss.png",
                   sf::IntRect{0, 0, 73 * 3, 55}),
      _midSprite(std::string(ASSETS_PATH) + "/sprites/the_eye/boss.png",
                 sf::IntRect{0, 55, 91 * 3, 55}),
      _longSprite(std::string(ASSETS_PATH) + "/sprites/the_eye/boss.png",
                  sf::IntRect{0, 55 * 2, 81 * 3, 55}),
      _laserSprite(std::string(ASSETS_PATH) + "/sprites/the_eye/laser_shoot.png",
                   sf::IntRect{0, 0, 30, 7}),
      _shootCooldown(0.0f),
