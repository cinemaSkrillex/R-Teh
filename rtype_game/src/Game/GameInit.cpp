...
Game::Game(std::shared_ptr<UDPClient> clientUDP, unsigned short client_port)
    : _clientUDP(clientUDP),
      ...
      _upSpaceship(std::string(ASSETS_PATH) + "/spaceship.png", sf::IntRect{0, 0, 32 * 2, 15}),
      _idleSpaceship(std::string(ASSETS_PATH) + "/spaceship.png", sf::IntRect{0, 15, 32, 15}),
      _downSpaceship(std::string(ASSETS_PATH) + "/spaceship.png",
                     sf::IntRect{0, 15 * 2, 33 * 2, 15}),
      _otherPlayer(std::string(ASSETS_PATH) + "/spaceship.png", sf::IntRect{0, 15, 32, 15}),
      _groundSprite(std::string(ASSETS_PATH) + "/r-type_front_line_base_obstacle_1.png"),
      _backgroundSprite(std::string(ASSETS_PATH) + "/r-type_background_front_line_base_4.png"),
      _eyeBomberSprite(std::string(ASSETS_PATH) + "/sprites/the_eye/bomber.png"),
      _eyeMinionSprite(std::string(ASSETS_PATH) + "/sprites/the_eye/minion.png"),
