...
void Controls::shoot(float deltaTime, RealEngine::Entity entity) {
    ...
    eventMessage.messageType = RTypeProtocol::MessageType::SHOOT_EVENT;
...
void Controls::holdShoot(float deltaTime, RealEngine::Entity entity) {
    auto* container = _registry.getComponent<RealEngine::NetvarContainer>(entity);
    ...
    RTypeProtocol::BaseMessage eventMessage;
    eventMessage.messageType = RTypeProtocol::MessageType::HOLD_SHOOT_EVENT;
...
void Controls::releaseShoot(float deltaTime, RealEngine::Entity entity) {
    ...
    _registry.removeComponent<RealEngine::ParticleEmitter>(entity);
    RTypeProtocol::BaseMessage eventMessage;
    eventMessage.messageType = RTypeProtocol::MessageType::RELEASE_SHOOT_EVENT;
